        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <!-- NOTAS -->
                    <div class="container p-0 bg-gray-700 rounded-lg">
...
<div class="mt-0 p-4 pt-0 grid divide-x divide-y rounded-xl overflow-hidden sm:grid-cols-2 lg:divide-y-0 lg:grid-cols-3 xl:grid-cols-5">
@foreach($notes as $key => $note)
            <div class="relative group bg-white border transition hover:z-[1] hover:shadow-2xl {{ $key === 0 ? ' rounded-l-xl' : '' }}{{ $key === (count($notes) - 1) ? ' rounded-r-xl' : '' }}">
...
<!-- Recordatorios -->
                    <div class="container p-0 mt-6 bg-gray-700 rounded-lg">
                    <div class="flex justify-between p-8">
